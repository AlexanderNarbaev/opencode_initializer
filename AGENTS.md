...
Модульная архитектура: 284-строчный оркестратор + 25 модулей + автообновление через systemd-таймер.
...
├── src/
│   ├── lib/          ← 25 модулей (00-core.sh … 21-rag.sh + helpers.sh + version-check.sh + pre-session-check.sh)
...
| `12-mcp-lsp.sh` | 21 MCP servers + 15 plugins + 13 LSP + Muninn + ChromaDB |
