...
**См. также:**
- [Начало работы](../getting-started/index.md) — руководство по установке
- [Руководство](../user-guide/index.md) — повседневное использование
- [Продвинутое](../advanced/index.md) — WSL2, GPU, кастомизация
- [Справочник](../reference/index.md) — CLI и схема конфигурации
