...
| 13 серверов, примеры, команды | 7 плагинов, безопасность | 6 провайдеров, цены, сравнение |
...
| 5 уровней защиты, чек-лист | 10 ролей, права, примеры | |

### 🔴 Экспертам — исследования и аналитика

| 🧠 [База знаний](KNOWLEDGE.md) |
|:---:|
| Глубокий анализ: модели, RAG, GPU, безопасность, CI/CD, галлюцинации, SGLang, память |
