...
description: 15 MCP-серверов: описание, примеры, команды. Model Context Protocol для AI-агентов.
---
...
## Активные по умолчанию (11 серверов)
...
### gitlab — взаимодействие с GitLab

Пакет: `@modelcontextprotocol/server-gitlab` · Команда: `npx -y @modelcontextprotocol/server-gitlab`

Работа с GitLab API: репозитории, merge requests, issues, CI/CD пайплайны.

### google-maps — геолокационные данные

Пакет: `@modelcontextprotocol/server-google-maps` · Команда: `npx -y @modelcontextprotocol/server-google-maps`

Геокодирование, маршруты, поиск мест через Google Maps API.
