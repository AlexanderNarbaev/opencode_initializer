...
- [Model Governance](governance/) — схема `model-policy.json`
- [Профили развёртывания](../guides/deployment-profiles/) — безопасность по профилям
- [Air-Gap & Offline](../guides/airgap-offline/) — режим isolated circuit
