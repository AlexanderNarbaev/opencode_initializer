...
| Режим | Флаг | Описание |
|-------|------|----------|
| **Полный** | *(по умолчанию)* | Полная установка — все 6 языков, 24 MCP, 21 плагин, 12 LSP |
...
| MCP/LSP | `12-mcp-lsp.sh` | 24 MCP + 21 плагин + 12 LSP + Muninn |
...
**См. также:**
- [MCP, LSP и плагины](../reference/mcp-lsp-plugins.md) — каталог 24+12+18 компонентов
- [Архитектура](../architecture/index.md) — C4-диаграммы и проектные решения
- [Руководство](../user-guide/index.md) — повседневный CLI
- [FAQ](../faq/index.md) — решение проблем
