...
| Command | Description |
|---------|-------------|
| `dev health` | Full diagnostics (65+ checks, 7 sections) |
...
Providers are dynamically built based on available API keys (16 total):
...
| Providers | `26-providers.sh` | 16 LLM provider registry with session switching |
...
**See also:**
- [MCP, LSP & Plugins](../reference/mcp-lsp-plugins/) — 21+13+15 component catalogue
