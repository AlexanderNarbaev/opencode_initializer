...
| **21 MCP-сервер** | :white_check_mark: авто | :x: | :x: | :x: | :x: (ручная настройка) | :x: |
| **15 плагинов OpenCode** | :white_check_mark: авто | :x: | :x: | :x: | :x: | :x: |
...
| **16 LLM-провайдеров** | :white_check_mark: динамически | :x: | :x: | :x: | :x: | :x: |
...
**Где OpenCode Initializer добавляет ценность:**
- MCP и LSP серверы настраиваются автоматически (21+13 серверов)
- Плагины OpenCode предустановлены и настроены (15 плагинов)
...
**Где OpenCode Initializer добавляет ценность:**
- AI-нативный: MCP-серверы, LSP-серверы, плагины OpenCode, 16 LLM-провайдеров
