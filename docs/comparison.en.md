...
| **6 languages auto-installed** | :white_check_mark: | :x: | :white_check_mark: (via nixpkgs) | :x: (manual per project) | :x: (manual Dockerfile) | :white_check_mark: |
...
| **22 LLM providers** | :white_check_mark: dynamic | :x: | :x: | :x: | :x: | :x: |
...
- 22 LLM providers (19 cloud + 3 local) with dynamic registration
...
**Where OpenCode Initializer adds value:**
- AI-native: MCP servers, LSP servers, OpenCode plugins, 22 LLM providers
