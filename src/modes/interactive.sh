#!/usr/bin/env bash
# src/modes/interactive.sh — interactive component-by-component selection
...
export INTERACTIVE_DO_SYSTEM="$DO_SYSTEM"
export INTERACTIVE_DO_DOCKER="$DO_DOCKER"
export INTERACTIVE_DO_CHROME="$DO_CHROME"
export INTERACTIVE_DO_ZSH="$DO_ZSH"
export INTERACTIVE_DO_JAVA="$DO_JAVA"
export INTERACTIVE_DO_NODE="$DO_NODE"
export INTERACTIVE_DO_PYTHON="$DO_PYTHON"
export INTERACTIVE_DO_GO="$DO_GO"
export INTERACTIVE_DO_RUST="$DO_RUST"
export INTERACTIVE_DO_DOTNET="$DO_DOTNET"
export INTERACTIVE_DO_OPENCODE="$DO_OPENCODE"
export INTERACTIVE_DO_MCP="$DO_MCP"
export INTERACTIVE_DO_CHROMA="$DO_CHROMA"
export INTERACTIVE_DO_SHOKUNIN="$DO_SHOKUNIN"
export INTERACTIVE_DO_TRIVY="$DO_TRIVY"
export INTERACTIVE_DO_PROJECT="$DO_PROJECT"
export INTERACTIVE_DO_LLM="$DO_LLM"
